...
from collective.nitf.core.config import PROJECTNAME
from collective.nitf.core.testing import INTEGRATION_TESTING

JS = [
    '++resource++collective.nitf.core/nitf_fixes.js',
    '++resource++collective.nitf.core/jquery.collapsible-v.2.1.3.js'
    ]

CSS = [
    '++resource++collective.nitf.core/collapsible.css',
    ]
